...
**Purpose:** Define the output structure and rules for producing `requirements.md`.
This skill defines HOW to write requirements — the agent invoking it supplies the input content.

---

## Output structure to produce in `requirements.md`
...
Must cover every FR plus edge cases: OR logic, combined filters, reset, count update, no-results message, mobile layout.
...
- Derive all requirements directly from the input content — do not invent requirements not mentioned.
- Commit message: `docs: add requirements for <feature name>`.
